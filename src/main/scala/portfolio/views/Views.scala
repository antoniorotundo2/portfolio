  ...
  private val svgs: Map[String, String] = Map(
    ...
    "zio" ->
      """<svg xmlns="http://www.w3.org/2000/svg"
          ...
          <defs>
            <linearGradient id="zioGradient" x1="0%" y1="100%" x2="100%" y2="0%">
